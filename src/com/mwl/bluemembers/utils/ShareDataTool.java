...
import com.mwl.bluemembers.model.MainEntity;
...
public class ShareDataTool {
	...
	public static boolean SaveInfo(Context context, UserInfoEntity infoEntity) {
		...
		if (infoEntity != null) {
			...
			e.putString("usercenter", infoEntity.usercenter);
			e.putString("abouthlife", infoEntity.abouthlife);
		} else {
			e.putInt("state", 0);
	...
	public static List<String> getWeather(Context context) {
		...
		if (ToosUtils.isStringEmpty(temp)) {
			...
			wList.add("32");
			wList.add("http://clubquestion.club-beijing-hyundai.com//public/uploads/w_0.png");
	...
	public static String getEventreport(Context context) {
		return context
				...
				.getString("eventreport",
						"http://clubquestion.club-beijing-hyundai.com/getevent.php");
	}
