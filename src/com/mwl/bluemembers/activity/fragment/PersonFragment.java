package com.mwl.bluemembers.activity.fragment;
...
import com.mwl.bluemembers.adapter.FMagazineAdapter;
...
public class PersonFragment extends Fragment implements OnClickListener {
	...
	private void setValues(UserInfoEntity infoEntity) {
		bitmapUtils.display(icon, infoEntity.face);
		nickName.setText(infoEntity.nickname);
		userName.setText("id: " + ShareDataTool.getPhone(getActivity()));
		String fontPath = "fonts/Modern.ttf";
		Typeface tf = Typeface.createFromAsset(getActivity().getAssets(),
				fontPath);
		scoretext.setTypeface(tf);
		scoretext.setText(String.valueOf(infoEntity.integral));
	}
